...
| Torrent root | `I:\torrentfiles`; mapped into Arr/Unpackerr containers as `/downloads` |

## Safety Rules

- Do not format, initialize, repartition, or wipe any existing media drive.
- Do not change drive letters casually.
- Confirm drive letters, native qBittorrent paths, and Docker bind mounts before trusting Plex, qBittorrent, Sonarr, Radarr, Bazarr, Tautulli, Jackett, or Unpackerr after boot, crash, Docker restart, or storage work.
...
| Homarr | [docs/services/homarr.md](docs/services/homarr.md) |
